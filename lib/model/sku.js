...
var Sku = /** @class */ (function () {
    ...
    Sku.getAttributeTypeMap = function () {
        return Sku.attributeTypeMap;
    };
    Sku.discriminator = undefined;
    Sku.attributeTypeMap = [
        {
            "name": "createdTime",
...
(function (Sku) {
    ...
    })(WeightUnitEnum = Sku.WeightUnitEnum || (Sku.WeightUnitEnum = {}));
